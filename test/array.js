...
exports["keySortOne"] = {
	...
	test: function (test) {
		test.expect(1);
		test.equal(retsu.keySort( this.arr.slice(), "abc" )[0].abc, 2, "Should be '2'");
		test.done();
	}
};
...
exports["keySortTwo"] = {
	...
	test: function (test) {
		test.expect(3);
		test.equal(retsu.keySort( this.arr.slice(), "abc, xyz desc" )[0].abc, 2, "Should be '2'");
		test.equal(retsu.keySort( this.arr.slice(), "abc, xyz desc" )[1].xyz, 6, "Should be '6'");
		test.equal(retsu.keySort( this.arr.slice(), "abc, xyz desc" )[2].xyz, 5, "Should be '5'");
		test.done();
	}
};
...
exports["keySortOneNested"] = {
	...
	test: function (test) {
		test.expect(1);
		test.equal(retsu.keySort( this.arr.slice(), "abc", "data" )[0].data.abc, 2, "Should be '2'");
		test.done();
	}
};
...
exports["keySortTwoNested"] = {
	...
	test: function (test) {
		test.expect(3);
		test.equal(retsu.keySort( this.arr.slice(), "abc, xyz desc", "data" )[0].data.abc, 2, "Should be '2'");
		test.equal(retsu.keySort( this.arr.slice(), "abc, xyz desc", "data" )[1].data.xyz, 6, "Should be '6'");
		test.equal(retsu.keySort( this.arr.slice(), "abc, xyz desc", "data" )[2].data.xyz, 5, "Should be '5'");
		test.done();
	}
};
...
exports["keys"] = {
	...
	test: function (test) {
		test.expect(1);
		test.equal(retsu.keys(this.val).length, 4, "Should be 4");
		test.done();
	}
};
