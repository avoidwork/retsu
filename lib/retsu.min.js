...
function(i){o.push(i)});return o},chunk:function(obj,size){var result=[],nth=number.round(obj.length/size,"up"),start=0,i=-1;while(++i<nth){start=i*size;result.push(array.limit(obj,start,size))}return result},clear:function(obj){return obj.length>0?array.remove(obj,0,obj.length):obj},clone:function(obj){return utility.clone(obj,true)},contains:function(obj,arg){return obj.indexOf(arg)>-1},collect:function(obj,fn){var result=[];array.each(obj,function(i){result.push(fn(i))});return result},compact:function(obj,
